const bankingApp = Vue.createApp({
    ...
    methods: {
        ...
        depositMoney() {
            ...
            Events.Subscribe("depositResponse", (data) => {
                if (data) {
                    const account = this.accounts.find((acc) => acc.name === this.selectedMoneyAccount.name);
                    if (account) {
                        account.balance += this.selectedMoneyAmount;
        ...
        internalTransfer() {
            ...
            Events.Subscribe("internalTransferResponse", (data) => {
                if (data) {
        ...
        externalTransfer() {
            ...
            Events.Subscribe("externalTransferResponse", (data) => {
                if (data) {
        ...
        orderDebitCard() {
            ...
            Events.Call("orderCard", {
                pin: this.debitPin,
            });

            Events.Subscribe("orderCardResponse", (data) => {
                if (data) {
                    this.debitPin = "";
                    this.addNotification(response.message, "success");
                } else {
        ...
        renameAccount() {
            ...
            Events.Call("renameAccount", {
                oldName: this.editAccount.name,
                newName: this.editAccountName,
            });

            Events.Subscribe("renameAccountResponse", (data) => {
                if (data) {
        ...
        deleteAccount() {
            ...
            Events.Call("deleteAccount", {
                accountName: this.editAccount.name,
            });

            Events.Subscribe("deleteAccountResponse", (data) => {
                if (data) {
        ...
        addUserToAccount() {
            ...
            Events.Subscribe("addUserResponse", (data) => {
                if (data) {
        ...
        removeUserFromAccount() {
            ...
            Events.Call("removeUser", {
                accountName: this.manageAccountName.name,
                userName: this.manageUserName,
            });

            Events.Subscribe("removeUserResponse", (data) => {
                if (data) {
                    let usersArray = JSON.parse(this.manageAccountName.users);
        ...
        closeApplication() {
            ...
            Events.Call("closeApp");
        },
    },
    mounted() {
        Events.Subscribe("openBank", (accounts, statements, playerData) => {
            let bankData = {
                accounts: accounts,
        ...
        Events.Subscribe("openATM", (accounts, acceptablePins, playerData) => {
            this.tempBankData = {
                accounts: accounts,
