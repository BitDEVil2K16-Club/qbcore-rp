...
function QBCore.Player.Logout(source)
    ...
    Events.CallRemote('QBCore:Client:OnPlayerUnload', source)
...
function QBCore.Player.CreatePlayer(PlayerData, Offline)
    ...
    function self.Functions.UpdatePlayerData()
        ...
        Events.CallRemote('QBCore:Player:SetPlayerData', self.PlayerData.source, self.PlayerData)
    end
    ...
    function self.Functions.SetJob(job, grade)
        ...
        if not self.Offline then
            ...
            Events.CallRemote('QBCore:Client:OnJobUpdate', self.PlayerData.source, self.PlayerData.job)
        end
    ...
    function self.Functions.SetGang(gang, grade)
        ...
        if not self.Offline then
            ...
            Events.CallRemote('QBCore:Client:OnGangUpdate', self.PlayerData.source, self.PlayerData.gang)
        end
    ...
    function self.Functions.Notify(text, type, length, icon)
        Events.CallRemote('QBCore:Notify', self.PlayerData.source, text, type, length, icon)
    end
    ...
    function self.Functions.AddMoney(moneytype, amount, reason)
        ...
        if not self.Offline then
            ...
            Events.CallRemote('hud:client:OnMoneyChange', self.PlayerData.source, moneytype, amount, false)
            Events.CallRemote('QBCore:Client:OnMoneyChange', self.PlayerData.source, moneytype, amount, 'add', reason)
    ...
    function self.Functions.RemoveMoney(moneytype, amount, reason)
        ...
        if not self.Offline then
            ...
            Events.CallRemote('hud:client:OnMoneyChange', self.PlayerData.source, moneytype, amount, true)
            if moneytype == 'bank' then
                Events.CallRemote('qb-phone:client:RemoveBankMoney', self.PlayerData.source, amount)
            end
            Events.CallRemote('QBCore:Client:OnMoneyChange', self.PlayerData.source, moneytype, amount, 'remove', reason)
    ...
    function self.Functions.SetMoney(moneytype, amount, reason)
        ...
        if not self.Offline then
            ...
            Events.CallRemote('hud:client:OnMoneyChange', self.PlayerData.source, moneytype, math.abs(difference), difference < 0)
            Events.CallRemote('QBCore:Client:OnMoneyChange', self.PlayerData.source, moneytype, amount, 'set', reason)
