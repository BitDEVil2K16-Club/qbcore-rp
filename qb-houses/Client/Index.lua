...
RegisterClientEvent('qb-houses:client:refresh', function(house_config)
...
RegisterClientEvent('qb-houses:client:ring', function(house)
...
RegisterClientEvent('qb-houses:client:view', function(house, houseprice, brokerfee, bankfee, taxes)
