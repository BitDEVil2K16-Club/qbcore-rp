...
Config.Shops = {
    ['pdm'] = {
        ...
        --['Location'] = Vector(-45.67, -1098.34, 26.42),         -- Blip Location
        --['ReturnLocation'] = Vector(-44.74, -1082.58, 26.68),   -- Location to return vehicle, only enables if the vehicleshop has a job owned
        ['VehicleSpawn'] = Vector(-56.79, -1109.85, 26.43),     -- Spawn location when vehicle is bought
        ['TestDriveSpawn'] = {
            location = Vector(-127.491244, 14050.276126, -400), -- Spawn location for test drive
            rotation = Rotator(0, 179, 0)
        },
        ['FinanceZone'] = Vector(-29.53, -1103.67, 26.42), -- Where the finance menu is located
        ['ShowroomVehicles'] = {
            {
                coords = { -- where the vehicle will spawn on display
                    location = Vector(-1769.242054, 15374.785969, -400),
                    rotation = Rotator(0, 268, 0)
                },
                defaultVehicle = 'bp_police', -- Default display vehicle
                chosenVehicle = 'bp_police',  -- Same as default but is dynamically changed when swapping vehicles
            },
            {
                coords = { -- where the vehicle will spawn on display
