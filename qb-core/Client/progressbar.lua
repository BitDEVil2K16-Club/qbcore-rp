...
-- local function StartActions(ped)
...
--     if (action.useWhileDead) and not isDoingAction then
--         isDoingAction = true
--         Action = action
--         SendNUIMessage({
--             action = 'progress',
...
-- Events.Subscribe('progressbar:client:ToggleBusyness', function(bool)
--     isDoingAction = bool
-- end)

-- Events.Subscribe('progressbar:client:progress', function(action, finish)
--     StartProgress(action, nil, nil, finish)
-- end)

-- Events.Subscribe('progressbar:client:ProgressWithStartEvent', function(action, start, finish)
--     StartProgress(action, start, nil, finish)
-- end)

-- Events.Subscribe('progressbar:client:ProgressWithTickEvent', function(action, tick, finish)
--     StartProgress(action, nil, tick, finish)
-- end)

-- Events.Subscribe('progressbar:client:ProgressWithStartAndTick', function(action, start, tick, finish)
--     StartProgress(action, start, tick, finish)
-- end)

-- Events.Subscribe('progressbar:client:cancel', function()
--     ActionCleanup()
--     my_webui:CallEvent({
--         action = 'cancel'
--     })
...
-- my_webui:Subscribe('FinishAction', function()
--     ActionCleanup()
-- end)
...
--     if key_name == 'Escape' and isDoingAction and Action.canCancel then
--         Events.Call('progressbar:client:cancel')
--         wasCancelled = true
--     end
-- end)
...
-- local function ProgressBar(action, finish)
--     StartProgress(action, nil, nil, finish)
-- end
-- Package.Export('ProgressBar', ProgressBar)

-- local function ProgressWithStartEvent(action, start, finish)
--     StartProgress(action, start, nil, finish)
-- end
-- Package.Export('ProgressWithStartEvent', ProgressWithStartEvent)

-- local function ProgressWithTickEvent(action, tick, finish)
--     StartProgress(action, nil, tick, finish)
-- end
-- Package.Export('ProgressWithTickEvent', ProgressWithTickEvent)

-- local function ProgressWithStartAndTick(action, start, tick, finish)
--     StartProgress(action, start, tick, finish)
-- end
-- Package.Export('ProgressWithStartAndTick', ProgressWithStartAndTick)

-- local function isDoingSomething()
--     return isDoingAction
-- end
-- Package.Export('isDoingSomething', isDoingSomething)
